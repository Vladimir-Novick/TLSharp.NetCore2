...
namespace TLSharp.Tests
{
    public class TLSharpTests
    {
        ...
        {
            NumberToSendMessage = MyClientConfig.GetConfigData.NumberToSendMessage;
